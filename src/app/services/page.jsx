...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-(--color-light)">
      {/* Hero Header Section */}
      <section
        className="relative h-125 flex flex-col items-center justify-center text-center px-4 overflow-hidden"
        style={{
          backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('/images/safari.jpg')`,
