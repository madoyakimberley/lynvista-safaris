...
import StatsSkeleton from "./stats-skeleton"; // Import the skeleton
...
export default function StatsOverview() {
  ...
  const stats = [
    { title: "Total Bookings", value: totalBookings, icon: Calendar },
    { title: "Paid Bookings", value: paidBookings, icon: DollarSign },
    { title: "Pending", value: pendingBookings, icon: Package },
  ];
